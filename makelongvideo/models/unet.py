...
from .resnet import Pseudo3DConv
...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def from_pretrained_2d(cls, pretrained_model_path, subfolder=None):
        ...
        for k, v in model.state_dict().items():
            ...
            if 'spatial_conv' in k:
                state_dict[k] = state_dict.pop(k.replace('spatial_conv.',''))
    ...
    @classmethod
    def from_pretrained_instance(cls, pretrained_model):
        ...
        # model_pretrai = pretrained_model
        for k, v in model.state_dict().items():
            ################## Commit 08-20 #################
            if k in state_dict.keys():
                continue
